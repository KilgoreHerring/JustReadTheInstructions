...
2. Product type - must be one of: "Residential Mortgage", "Personal Loan", "Credit Card", "Current Account", "Savings Account", "Investment Product (Retail)", "General Insurance", "Payment Service"
